            ...
            <div class="row container mx-auto">
                ...
                <p class="text-center" style="color:green;"><?php if(isset($_GET['login_sucess'])){echo $_GET['login_sucess'];}?></p>
                    ...
                    <div class="account-info">
                        <p>Name: <spam><?php if(isset($_SESSION['user_name'])) {echo $_SESSION['user_name']; }?></spam></p>
                        <p>Email: <spam><?php if(isset($_SESSION['user_email'])) {echo $_SESSION['user_email']; }?></spam></p>
